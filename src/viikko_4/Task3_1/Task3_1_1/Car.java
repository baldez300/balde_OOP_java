...
/*
    Using your earlier Car class create SportsCar class that has better acceleration
    and deceleration (and higher gasoline consumption) than an ordinary Car.
*/
...
public class Car {
    ...
    public void setSpeed(float newSpeed) {
        if (newSpeed >= 0 && newSpeed <= topSpeed && gasolineLevel > 0) {
            speed = newSpeed;
        } else if (newSpeed < 0) {
            speed = 0;
        }
